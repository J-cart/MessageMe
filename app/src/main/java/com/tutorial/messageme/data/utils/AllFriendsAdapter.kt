...
class AllFriendsAdapter : ListAdapter<UserBody, AllFriendsAdapter.ViewHolder>(DiffCallBack) {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(data: UserBody) {
            ...
            binding.profileBtn.text = "OPEN CHAT"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllFriendsAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: AllFriendsAdapter.ViewHolder, position: Int) {
